...
export function Features() {
  const features = [
    { icon: <Maximize className="w-8 h-8" />, title: "103m²", subtitle: "Área Construída" },
    ...
    <section id="detalhes" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-stone-900 mb-6 tracking-tight">O Imóvel Perfeito para Você</h2>
          <p className="text-lg text-stone-600 max-w-2xl mx-auto">
            Design moderno, ambientes integrados e uma área de lazer incrível para sua família desfrutar os melhores momentos.
          </p>
          <div className="mt-10 inline-block bg-stone-50 border border-stone-200 px-8 py-4 rounded-2xl shadow-sm">
            <span className="text-stone-500 uppercase tracking-wider text-sm font-semibold">Valor do Investimento</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center text-center p-8 rounded-3xl bg-stone-50 border border-stone-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
