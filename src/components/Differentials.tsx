...
export function Differentials() {
  const items = [
    "Piso e paredes em porcelanato Elizabeth 1,00x1,00",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-5xl font-bold text-stone-900 mb-6 tracking-tight">Acabamento Premium em Cada Detalhe</h2>
            <p className="text-lg text-stone-600 mb-10">
              A casa foi construída com materiais de altíssima qualidade, pensando no seu conforto, durabilidade e sofisticação.
            </p>
