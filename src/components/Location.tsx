      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-stone-600 max-w-2xl mx-auto">
            Condomínio Sunville, com segurança, lazer e tranquilidade para sua
            família viver os melhores momentos.
          </p>
        </div>
        ...
        <div className="bg-stone-50 rounded-[2rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 border border-stone-100 shadow-sm max-w-4xl mx-auto">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-2xl md:text-3xl font-bold text-stone-900 mb-2">
              Avenida Escritor Ramalho Leite
            </h3>
            <p className="text-stone-600 text-xl">Bairro Mucumagro, João Pessoa - PB</p>
            <p className="text-stone-500 mt-2 font-mono bg-stone-200/50 inline-block px-3 py-1 rounded-md">
              CEP: 58066-150
            </p>
          </div>
        </div>
