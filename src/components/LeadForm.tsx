        ...
        <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row">
          <div className="md:w-2/5 bg-stone-100 p-12 text-stone-900 flex flex-col justify-between">
            <div>
              ...
              <p className="text-stone-600 font-medium mb-8 text-lg leading-relaxed">
                Fale diretamente comigo pelo WhatsApp para receber o material
                completo, planta baixa e agendar uma visita ao imóvel.
              </p>
            </div>
            <div className="space-y-4">
              <div className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
                <img
                  ...
                  alt="Área gourmet com piscina privativa"
                  className="w-full h-48 object-cover"
                />
                <div className="p-5">
                  <p className="text-sm text-stone-500 uppercase font-bold tracking-wider mb-2">
                    Ambiente em destaque
                  </p>
                  <p className="text-lg font-semibold text-stone-900">
                    Piscina e espaço gourmet integrados
                  </p>
                </div>
              </div>
          ...
          <div className="md:w-3/5 p-12 flex flex-col items-center justify-center text-center bg-white">
            ...
            <p className="text-stone-600 mb-8 text-lg max-w-md">
              Clique no botão abaixo e tire todas as suas dúvidas agora mesmo,
              direto no WhatsApp.
            </p>
            <a
              href={whatsappUrl}
